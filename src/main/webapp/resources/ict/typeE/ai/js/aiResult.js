$(document).ready(function () {
    ...
    function getData() {
        $.ajax({
            url: "/yc/ict/smartBook/aiResultList.do?question=" + searchText + "&context_path=" + context_path + "&sourceType=" + source_type,
            type: "GET",
            dataType: "json",
                ...
                $('.tabMenu div').off().on('click', function () {
                    ...
                    if ($(this).hasClass("tabInfo")) {
                        ...
                        if (!res) {
                            ...
                            $.ajax({
                                url: "/yc/ict/smartBook/aiLibraryagent.do?search_text=" + searchText ,
                                type: "GET",
                                dataType: "json",
                                success: function (res){
                                    chatText = res.res;
...
function seoga(vLoca, vCtrl) {
    ...
    const bookDetailUrl = `/yc/ict/smartBook/getDetailInfo.do?vLoca=${vLoca}&vCtrl=${vCtrl}`;
    $.ajax({
        url: bookDetailUrl,
        type: 'GET',
        dataType: 'json',
