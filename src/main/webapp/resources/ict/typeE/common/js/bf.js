$(function () {
    ...
    const resetContainer = () => {
        ...
        $scrollToggle
                .text('화면내리기')
                .css('background-image', 'url(/resources/ict/typeD/common/img/wave/scrollDown.png)');
    ...
    $scrollToggle.on('click', () => {
        console.log('SCROLL CLICK', state.isScrolledDown);
        ...
        if (state.isScrolledDown) {
            ...
            $scrollToggle
                    .text('화면올리기')
                    .css('background-image', 'url(/resources/ict/typeD/common/img/wave/scrollUp.png)');
            $container.css({
                transition: 'height 0.6s ease, margin-top 0.6s ease',
    ...
    $('.navigation a').each(function () {
        ...
        if (currentPath.includes('/yy/ict/smart/keyword.do') && $(this).attr('id') === 'chart') {
            $(this).addClass('active');
        }
    });
