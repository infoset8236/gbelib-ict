$(function () {
    ...
    const applyZoom = () => {
        ...
        if (state.active) {
            $magnifierContent.css({
                ...
                transformOrigin: 'top left',                width: $body[0].scrollWidth,
    ...
    const resetContainer = () => {
        ...
        $scrollToggle
            .text('화면내리기')
            .css('background-image', 'url(/resources/ict/kioskVertical/img/type_b/info/nav/scrollDown.png)');
    ...
    $scrollToggle.on('click', () => {
        ...
        if (state.isScrolledDown) {
            ...
            $scrollToggle
                .text('화면올리기')
                .css('background-image', 'url(/resources/ict/kioskVertical/img/type_b/info/nav/scrollUp.png)');
            $container.css({
                transition: 'height 0.6s ease, margin-top 0.6s ease',
