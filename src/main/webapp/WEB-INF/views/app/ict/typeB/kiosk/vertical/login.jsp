...
<div class="container">
	<div class="wrapper">
		...
		<form:form modelAttribute="member" action="/${homepage.context_path}/ict/kiosk/vertical/loginProc.do" onsubmit="return false;">
			...
			<div class="input_wrapper">
				...
				<div class="rfid_login" role="button" onclick="location.href='/${homepage.context_path}/ict/kiosk/vertical/rfidLogin.do'">회원증 RFID로 로그인</div>
			</div>
		</form:form>
	</div>
