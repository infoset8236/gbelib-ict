...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_b/a_line_of_book.css" rel="stylesheet" type="text/css" />
		<script src="/resources/ict/mediawall/js/type_b/wisesaying.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/js/type_b/a_line_of_book.js" type="text/javascript"></script>
	...
	<div class="div_wrap bookline-wrap" id="fade-effect">
		<img class="bg_wrap" src="/resources/ict/mediawall/img/type_b/a_line_of_book/bg_line.png" />
