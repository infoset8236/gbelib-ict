...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_b/welcome_message.css" rel="stylesheet" type="text/css" />
		<script src="/resources/ict/mediawall/plugin/jquery-3.7.1.min.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/js/type_b/welcome_message.js" type="text/javascript"></script>
		<title>환영메시지</title>
	</head>
	<body>
		<div class="div_wrap welcome_wrap">
			<img class="bg_wrap" src="/resources/ict/mediawall/img/type_b/welcome_message/bg_welcome.png" />
