...
<div class="lib_living_container">
    <div class="lib_date_wrapper">
        <div class="lib_living_date"></div>
        <div class="lib_living_weather" id="current_condition"></div>
    </div>
    <div class="lib_living_temperature_wrapper">
        <div class="lib_living_temperature" id="current_temp"></div>
    </div>
    <div class="lib_living_perceived_temperature">체감온도 <span id="feels_like"></span></div>
    <div class="lib_living_detail">
        <div class="lib_living_label">
            <img alt="" src="/resources/ict/info/img/dust.svg" />
            <div>미세먼지</div>
        </div>
        <div class="lib_living_value" id="dust_condi_txt"></div>
    </div>
    <div class="lib_living_detail">
        <div class="lib_living_label">
            <img alt="" src="/resources/ict/info/img/poisoning.svg" />
            <div>식중독</div>
        </div>
        <div class="lib_living_value" id="food_condi_txt">주의</div>
    </div>

    <div class="lib_living_weather_list" id="forecast_frame">

    </div>

    <div class="lib_living_news_list">
        <div class="lib_living_news_list_title">
            <div>NEWS</div>
            <img alt="" src="/resources/ict/info/img/news.svg" />
        </div>
        <div class="lib_living_news_list_swiper swiper">
            <div class="swiper-wrapper" id="news_frame">
                <c:forEach items="${livingInfoList}" var="i" varStatus="status">
                <div class="swiper-slide">
                    <div class="lib_living_news_dot">ㆍ</div>
                    <div class="lib_living_news_content">
                        <div class="lib_living_news_title">${i.title}</div>
                        <div class="lib_living_news_date">${i.pubDate}</div>
                    </div>
                </div>
                </c:forEach>
            </div>
