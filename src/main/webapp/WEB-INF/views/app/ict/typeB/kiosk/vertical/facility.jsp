...
<head>
    ...
    <link href="/resources/ict/kioskVertical/css/type_b/facility.css" rel="stylesheet" type="text/css" />
   ...
   <script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
    <script src="/resources/ict/kioskVertical/js/type_b/info/facility.js" type="text/javascript"></script>
</head>

<body>
    <div class="faci_wrap info">
        <div class="header">
            <p>FACILITY</p>
            <h1>시설안내</h1>
        </div>
        <div class="contents">
            <div class="faci_tab">
                ...
                <!--<a class="" data-tab="m_tab5" href="javascript:void(0)">4F</a>-->
            </div>
            <div class="tabs">
                <!--탭메뉴-->
                <div class="faci_tab_cont">
                    <div class="tab_content active" id="m_tab1">
                        <div class="floor_page">
                            <div class="map_wrapper">
							     <div class="floor_text">B1F</div>
                                <img class="faci_img" src="/resources/ict/kioskVertical/img/type_b/info/facility/mapB01_v.png" alt="지하1층 지도" />
                            </div>
                            <div class="floor_slide_01 swiper-container">
                    ...
                    <div class="tab_content" id="m_tab2">
                        <div class="floor_page">
							...
							<div class="floor_text">1F</div>
                                <img class="faci_img" src="/resources/ict/kioskVertical/img/type_b/info/facility/map01_v.png" alt="1층지도" />
                            </div>
                            <div class="floor_slide_02 swiper-container">
                               <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <ul class="small_photo">
                                        <li class="photo_frame">
                    ...
                    <div class="tab_content" id="m_tab3">
                        <div class="floor_page">
                            <div class="map_wrapper">
							<div class="floor_text">2F</div>
                                <img class="faci_img" src="/resources/ict/kioskVertical/img/type_b/info/facility/map02_v.svg" alt="2층지도" />
                            </div>
                            <div class="floor_slide_03 swiper-container">
                               <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <ul class="small_photo">
                                        <li class="photo_frame">
                                            ...
                                            <a class="faci_mapping_05" href="#this">
                                                <div class="btn_faci_01 faci_total" href="#this">
                                                    <div class="pic_txt_frame">
                                                        ...
                                                        <div class="pic_txt">평생학습실(배움1실)</div>
                                                    </div>
                                            ...
                                            <a class="faci_mapping_06" href="#this">
                                                <div class="btn_faci_01 faci_total" href="#this">
                                                    <div class="pic_txt_frame">
                                                        ...
                                                        <div class="pic_txt">평생학습실(배움2실)</div>
                                                    </div>
                                            ...
                                            <a class="faci_mapping_07" href="#this">
                                                <div class="btn_faci_01 faci_total" href="#this">
                                                    <div class="pic_txt_frame">
                                                        ...
                                                        <div class="pic_txt">평생학습실(나눔1실)</div>
                                                    </div>
                                            ...
                                            <a class="faci_mapping_08" href="#this">
                                                <div class="btn_faci_01 faci_total" href="#this">
                                                    <div class="pic_txt_frame">
                                                        ...
                                                        <div class="pic_txt">평생학습실(나눔2실)</div>
                                                    </div>
                                            ...
                                            <a class="faci_mapping_09" href="#this">
                                                <div class="btn_faci_01 faci_total" href="#this">
                                                    <div class="pic_txt_frame">
                                                        ...
                                                        <div class="pic_txt">평생학습실(나눔3실)</div>
                                                    </div>
                                            ...
                                            <a class="faci_mapping_10" href="#this">
                                                <div class="btn_faci_01 faci_total" href="#this">
                                                    <div class="pic_txt_frame">
                                                        ...
                                                        <div class="pic_txt">평생학습실(채움1실)</div>
                                                    </div>
                                            ...
                                            <a class="faci_mapping_11" href="#this">
                                                <div class="btn_faci_01 faci_total" href="#this">
                                                    <div class="pic_txt_frame">
                                                        ...
                                                        <div class="pic_txt">평생학습실(채움2실)</div>
                                                    </div>
                    ...
                    <div class="tab_content" id="m_tab4">
                        <div class="floor_page">
                            <div class="map_wrapper">
							<div class="floor_text">3F</div>
                                <img class="faci_img" src="/resources/ict/kioskVertical/img/type_b/info/facility/map03_v.svg" alt="3층 지도" />
                            </div>
                            <div class="floor_slide_03 swiper-container">
                               <div class="swiper-wrapper">
                                <div class="swiper-slide">
                    ...
                    <!--<div class="tab_content" id="m_tab5">
                        <div class="floor_page">
                            <div class="map_wrapper">
                                <img class="faci_img" src="/resources/ict/kioskVertical/img/type_b/info/facility/map04.png" alt="4층 지도" />
                            </div>
                            <div class="floor_slide_04">
                                    <h3>데이터가 없습니다</h3>
                            </div>
                        </div>
                    </div>-->
...
<div class="modal" id="imageModal_01">
    <div class="pop-info">
        <div class="modal_main">
            <img alt="" class="modal_main_img" src="/resources/ict/kioskVertical/img/type_b/info/facility/computer.jpg" />
        </div>
        <div class="line_03"></div>
        <a class="modal_a_01" href="#this" id="closeButton">
            <div class="ic-print"><img class="close_mark" src="/resources/ict/kioskVertical/img/type_b/info/facility/close.svg" /></div>
        ...
        <div class="pop_totaltxt">
            ...
            <!--<div class="txt_frame">
                <div class="txt_box">
                    기후 위기와 생태환경 주제 도서가 모여있는 ‘에코(공존ECO)존’, 만화책을 열람할 수 있는 ‘코믹스’ 코너, 조용히 독서에 몰입할 수 있는 ‘집중독서존’ 운영
                    <br />
...
<div class="modal" id="imageModal_02">
    <div class="pop-info">
        <div class="modal_main">
            <img alt="" class="modal_main_img" src="/resources/ict/kioskVertical/img/type_a/info/facility/chilid_data.jpg" />
        </div>
        <div class="line_03"></div>
        <a class="modal_a_01" href="#this" id="closeButton">
            <div class="ic-print"><img class="close_mark" src="/resources/ict/kioskVertical/img/type_b/info/facility/close.svg" /></div>
...
<div class="modal" id="imageModal_03">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_04">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_05">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_06">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_07">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_08">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_09">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_10">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_11">
    <div class="pop-info">
        <div class="modal_main">
...
<div class="modal" id="imageModal_12">
    <div class="pop-info">
        <div class="modal_main">
        ...
        <div class="pop_totaltxt">
            <div class="text_check">
                <div class="text_wrap_ex"><h4>3층 종합자료실은 기존 자료대출 · 반납만을 위한 공간에서 탈피하여 지역주민들의 편안한 독서
