...
<head>
    ...
    <link href="/resources/ict/smartBook/css/type_b/book_information_ver.css" rel="stylesheet" type="text/css" />
...
<div class="div_wrap booksearch_info_wrap detail_wrap info" id="keyword_result">
			...
			<div class="swiper-wrapper">
                    ...
                    <div class="bookwrap_frame">
                        ...
                        <div class="right_info">
                            ...
                            <div class="book_story_wrap scroll">
                                ...
                                <p>${detail.dsItemDetail[0].contentsDetail}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <c:choose>
                    <c:when test="${fn:length(newBookList.dsNewBookList) > 0}">
                        <c:forEach items="${newBookList.dsNewBookList}" var="i" varStatus="status" begin="1" end="5">
                            <div class="info_bookwrap swiper-slide">
                                <div class="bookwrap_frame">
                                    <div class="left_info">
                                        <div class="bookimg_ellipse"></div>
                                    ...
                                    <div class="right_info">
                                        ...
                                        <div class="bookinfo_sort"><span class="wrtier_info_n">${i.AUTHOR}</span>
                                            <span class="info_slash">&nbsp;/&nbsp;</span>
...
<script src="/resources/ict/smartBook/js/type_b/book_information_ver.js" type="text/javascript"></script>
</body>
<div id="popup" class="popup-overlay book_over" style="display: none">
    <div class="popup-content">
        <div class="popup-wrapper">
            <div class="popup-title">서가위치</div>
            <img class="map" src="/resources/ict/smartBook/img/type_b/book_information/map.png" alt="" />
        </div>
        <div class="action_bt">
            <div class="close_bt">
                <img src="/resources/ict/smartBook/img/type_b/book_information/close.svg" alt="" />
                <div>닫기</div>
            </div>
            <div class="print_bt">
                <img src="/resources/ict/smartBook/img/type_b/book_information/print.svg" alt="" />
                <div>인쇄</div>
            </div>
        </div>
    </div>
