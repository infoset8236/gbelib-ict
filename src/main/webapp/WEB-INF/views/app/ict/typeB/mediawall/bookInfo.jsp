...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_b/best_book.css" rel="stylesheet" type="text/css" />
	...
	<body>
		<div class="div_wrap bookinfo-wrap" id="fade-effect">
			<img class="bg_wrap" src="/resources/ict/mediawall/img/type_b/best_book/bookinfo.png" />
			<div class="bg_point_01"><img src="/resources/ict/mediawall/img/type_b/best_book/bg_binfo_02.svg" /></div>
