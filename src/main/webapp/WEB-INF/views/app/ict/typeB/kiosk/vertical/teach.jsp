...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/kioskVertical/css/type_b/course_information.css" rel="stylesheet" type="text/css" />
		...
		<script src="/resources/ict/kioskVertical/js/type_b/info/course_information.js" type="text/javascript"></script>
	</head>
	<body>
		...
		<div class="culture-wrap info">
			...
			<div class="contents">
				<div class="culture-inner-box bslide-box">
					...
					<!-- <span class="status_0">접수중</span> -->
					<!-- <span class="status_1">대기자<br />신청</span> -->
					<!-- <span class="status_2">후보<br />신청</span> -->
					<!-- <span class="status_3">신청<br>대기</span> -->
					<!-- <span class="status_4">접수<br>마감</span> -->
													...
													<ul>
														<li>
															...
															<p class="cul-cnt-state">
																<span  class="counter">${i.teach_join_count}</span>
                                                                <span class="slash_01">/</span><span>${i.teach_limit_count}</span>
															</p>
														</li>
														<li>
															<p class="cul-cnt-tit">후보인원</p>
															<p class="cul-cnt-state">
																<span class="counter">${i.teach_backup_join_count}</span>
																<span class="slash_01">/</span><span>${i.teach_backup_count}</span>
															</p>
														</li>
													</ul>
												</div>
					...
					<c:if test="${fn:length(teachList) > 7}">
						<div class="bx-slide">
					...
					<c:if test="${fn:length(teachList) > 14}">
						<div class="bx-slide">
							<c:forEach items="${teachList}" var="i" varStatus="status" begin="14" end="20">
								<div class="culture-list">
									<a class="detail-btn" href="javascript:void(0);">
										<div class="outer">
											<div class="inner" onclick="goDetail('${i.group_idx}','${i.category_idx}','${i.teach_idx}','${i.large_category_idx}');">
