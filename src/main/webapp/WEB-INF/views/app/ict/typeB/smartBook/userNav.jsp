...
<div class="left_bottom">
	...
	<c:choose>
		...
		<c:otherwise>
			<div class="user" onclick="location.href='/${homepage.context_path}/ict/smartBook/login.do'">
				<div class="login_btn">
					<img alt="" class="login_women" src="/resources/ict/smartBook/img/common/userlog.png" />
					<div class="name_div">
						<span class="name_wrap">
							<span class="name_span" id="name_id">로그인</span>
