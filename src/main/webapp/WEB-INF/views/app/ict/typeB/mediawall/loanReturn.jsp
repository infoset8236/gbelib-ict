...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/font.css" rel="stylesheet" />
		<link href="/resources/ict/mediawall/css/type_b/book_loan_return_date.css" rel="stylesheet" type="text/css" />
		<script src="/resources/ict/mediawall/plugin/jquery-3.7.1.min.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/plugin/flipclock.min.js" type="text/javascript"></script>
		<title>대출반납일</title>
	</head>
	<body>
	<div class="container">
