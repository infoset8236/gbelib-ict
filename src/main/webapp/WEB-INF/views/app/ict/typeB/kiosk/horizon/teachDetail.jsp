...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/resources/ict/kioskHorizon/css/type_b/course_detail.css" />
	...
	<div class="culture-wrap info detail_wrap info">
		<div class="header">
		...
		<div class="content">
			<div class="box">
				<div class="first">
					<div class="icon_wrapper">
						<img alt="" src="/resources/ict/kioskHorizon/img/type_b/course_detail/pencil.svg" />
					</div>
					<div class="text_wrapper">
						<div class="label black_label">강좌명</div>
				...
				<div class="second">
					<div class="border date_wrapper">
						<div class="icon_wrapper">
							<img alt="" src="/resources/ict/kioskHorizon/img/type_b/course_detail/calendar.svg" />
						</div>
						<div class="course_date_wrapper">
							<div class="label">강좌기간</div>
							<div class="course_date">${teach.start_date} ~ ${teach.end_date}</div>
						</div>
					</div>
					<div class="date_wrapper">
						<div class="icon_wrapper">
							<img alt="" src="/resources/ict/kioskHorizon/img/type_c/course_detail/mouse.svg" />
						</div>
			...
			<div class="course_detail">
				...
				<div class="course_detail_third">
					<div class="course_detail_label padding" style="font-weight:500;">• 강의설명</div>
					<div class="scroll">
