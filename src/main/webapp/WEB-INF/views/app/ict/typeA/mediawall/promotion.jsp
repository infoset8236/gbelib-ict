...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_a/promotion.css" rel="stylesheet" type="text/css" />
		<script src="/resources/ict/mediawall/plugin/jquery-3.7.1.min.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/js/type_a/promotion.js" type="text/javascript"></script>
		<title>홍보동영상</title>
	</head>
	<body>
	<div class="div_wrap infopromotion-wrap" id="fade-effect">
		<img class="bg_wrap" src="/resources/ict/mediawall/img/type_a/promotion/mediawall_promotion.png" />
		...
		<div class="contents">
			...
			<div class="center-sec">
				...
				<div class="movie-box" id="movie-box">
					<div class="outer">
						<div class="inner">
							<img alt="pomotion" src="/resources/ict/mediawall/img/type_a/promotion/madiawall_promotion_con.png" />
