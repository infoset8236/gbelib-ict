...
<head>
	...
	<link href="/resources/ict/kioskHorizon/css/type_b/common.css" rel="stylesheet" type="text/css " />
		...
		$('.login').on('click', function(e) {
			...
			$.ajax({
				...
				success: function(response) {
					if (response.valid) {
						location.href='/${homepage.context_path}/ict/kiosk/horizon/teach.do';
					} else {
...
<div class="container">
	<div class="wrapper">
		...
		<form:form modelAttribute="member" action="/${homepage.context_path}/ict/kiosk/horizon/loginProc.do" onsubmit="return false;">
			<form:hidden path="member_pw" cssStyle="display:none;" />
			<form:hidden path="member_id"/>
			<div class="input_wrapper">
				<label class="label" for="member_id_tmp">
					<img alt="" src="/resources/ict/common/img/card.svg">
				...
				<div class="rfid_login" role="button" onclick="location.href='/${homepage.context_path}/ict/kiosk/horizon/rfidLogin.do'">회원증 RFID로 로그인</div>
			</div>
		</form:form>
	</div>
