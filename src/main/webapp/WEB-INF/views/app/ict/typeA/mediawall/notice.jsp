...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_a/notice.css" rel="stylesheet" type="text/css" />
		...
		<script src="/resources/ict/mediawall/js/type_a/notice.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/plugin/swiper-bundle.min.js" type="text/javascript"></script>
		<title>공지사항</title>
	</head>
	<body>
	<div class="div_wrap notice_info">
		<img class="bg_wrap" src="/resources/ict/mediawall/img/type_a/notice/mediawall_notice.png" />
