...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/kioskHorizon/css/type_a/best_book.css" rel="stylesheet" type="text/css" />
		...
		<script src="/resources/ict/kioskHorizon/js/type_a/best_book.js" type="text/javascript"></script>
	</head>
	<body>
	...
	<div class="container">
		<div class="header_wrapper">
			<div class="header_caption">BEST BOOK</div>
			<div class="header_title">대출베스트</div>
		</div>
		<div class="content">
