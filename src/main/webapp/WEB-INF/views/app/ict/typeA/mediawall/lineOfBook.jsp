...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_a/a_line_of_book.css" rel="stylesheet" type="text/css" />
		<script src="/resources/ict/mediawall/js/type_a/wisesaying.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/plugin/jquery-3.7.1.min.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/js/type_a/a_line_of_book.js" type="text/javascript"></script>
		<!--<script src="/resources/ict/mediawall/js/type_a/wisesaying.js" type="text/javascript"></script>-->
		<title>책속한줄</title>
	</head>
	<body>
	<div class="div_wrap bookline-wrap" id="fade-effect">
		<img class="bg_wrap" src="/resources/ict/mediawall/img/type_a/a_line_of_book/leaves.png" />
