...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_a/event.css" rel="stylesheet" type="text/css" />
		...
		<script src="/resources/ict/mediawall/js/type_a/event.js" type="text/javascript"></script>
		<title>오늘의 행사</title>
	</head>
	<body>
	<div class="div_wrap today_wrap">
		<img class="bg_wrap" src="/resources/ict/mediawall/img/type_a/event/today_bg.png" />
