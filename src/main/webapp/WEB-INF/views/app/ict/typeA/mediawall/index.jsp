...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/mediawall/css/type_a/welcome_message.css" rel="stylesheet" type="text/css" />
		<script src="/resources/ict/mediawall/plugin/jquery-3.7.1.min.js" type="text/javascript"></script>
		<script src="/resources/ict/mediawall/js/type_a/welcome_message.js" type="text/javascript"></script>
		<title>환영메시지</title>
	</head>
	<body>
		<div class="div_wrap welcome_wrap">
			<img class="bg_wrap" src="/resources/ict/mediawall/img/type_a/welcome_message/mediawall_welcome.png" />
			<img class="rectangle-dim" src="/resources/ict/mediawall/img/type_a/welcome_message/dim.svg" />
			...
			<div class="lib_tit">${homepage.homepage_name} LIBRARY</div>
			<%--<div class="ticker">
