...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/typeE/smart/css/index.css">
    ...
    <script src="/resources/ict/typeE/common/js/keyPadController.js?v=1.5"></script>
    <script src="/resources/ict/typeE/common/js/common.js?v=1.5"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js"></script>
    <script src="/resources/ict/typeE/smart/js/index.js?v=1.2"></script>
    ...
    <div class="container" tabindex="0">
        <div class="scrollDownArea">
            ...
            <div class="content">
                ...
                <div class="searchBox">
                    <img class="decoration" src="/resources/ict/typeE/smart/img/index/character.apng" alt="">
                    ...
                    <div class="searchForm">
                        ...
                        <button class="submit" tabindex="0" aria-label="검색하기">
                            <img src="/resources/ict/typeE/smart/img/index/search.svg" alt="">
                        </button>
                    </div>
                </div>

                <div class="recommendIntro" tabindex="0">
                    <img class="decoration1" src="/resources/ict/typeE/smart/img/index/book.png" alt="">
                    <img class="decoration2" src="/resources/ict/typeE/smart/img/index/heart.apng" alt="">
