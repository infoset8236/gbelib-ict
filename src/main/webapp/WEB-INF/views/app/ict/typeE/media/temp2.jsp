...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/dglib/media/css/temp2.css">
    ...
    <script src="/resources/ict/dglib/media/js/temp2.js"></script>
...
<div class="noticeWrapper">
    <div class="noticeContent">
        <div class="noticeMain">임시운영 기간에는 열람만 가능합니다!<br>(대출,반납,예약 불가)</div>
        <div class="noticeSub">*정식 개관인 <b>11월 5일</b>부터 대출가능</div>
    </div>
</div>