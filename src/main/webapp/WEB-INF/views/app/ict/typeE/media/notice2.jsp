...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/typeE/media/css/notice2.css?v=4">
    ...
    <script src="/resources/ict/typeE/media/js/notice2.js?v=4"></script>
...
<div style="display: flex;  overflow:hidden;">
    <div class="infoPanelContainer">
        <div class="panelHeader">
            ...
            <div class="panelPagination"><span class="panelCurrent">1</span><span class="panelTotal">/1</span></div>
        </div>
        <div class="infoList">
    ...
    <jsp:include page="/WEB-INF/views/app/ict/typeE/media/loanReturn.jsp" />
</div>
