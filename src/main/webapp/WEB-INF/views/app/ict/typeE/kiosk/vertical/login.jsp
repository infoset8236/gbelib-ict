...
<head>
	...
	<link href="/resources/ict/typeE/common/css/login.css?v=2" rel="stylesheet" type="text/css" />
		...
		$('.login').on('click', function(e) {
			...
			$.ajax({
				...
				success: function(response) {
					if (response.valid) {
						location.href='/${homepage.context_path}/ict/kiosk/vertical/index.do';
					} else {
...
<div class="dim">
    <div id="container" class="container">
        <div class="wrapper">
            ...
            <form:form modelAttribute="member" action="/${homepage.context_path}/ict/kiosk/vertical/loginProc.do"
                ...
                <div class="input_wrapper">
                    <label class="label" for="member_id_tmp">
                        ...
                        <input class="input" id="member_id_tmp" name="member_id_tmp" placeholder="아이디를 입력해주세요"
                               type="text">
                    </label>
                    <label class="mt label" for="member_pw_tmp">
                        <img alt="" src="/resources/ict/common/img/lock.png">
                        <input class="input" id="member_pw_tmp" name="member_pw_tmp" placeholder="비밀번호를 입력해주세요"
                               type="password" autocomplete="new-password">
                    </label>

                    <div class="login" role="button">로그인</div>
                    <div class="caption">회원증으로 간편로그인하세요</div>
                    <div class="rfid_login" role="button"
                         onclick="location.href='/${homepage.context_path}/ict/kiosk/vertical/rfidLogin.do'">회원증 RFID로
                        로그인
                    </div>
                </div>
            </form:form>
