...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/typeE/account/css/rfid.css?v=1.2">
...
<%--    <script src="/resources/ict/typeE/common/js/virtualKeyboard.js" type="text/javascript"></script>--%>
<%--    <link href="/resources/ict/typeE/common/css/virtualKeyboard.css" rel="stylesheet" type="text/css"/>--%>
        ...
        <div class="scrollDownArea">
            <div class="content">
                ...
                <div class="decoration">
                    <img class="signal1" src="/resources/ict/typeE/account/img/signal1.svg" alt="">
                    <img class="signal2" src="/resources/ict/typeE/account/img/signal2.svg" alt="">
                    <img class="card" src="/resources/ict/typeE/account/img/rfid.png" alt="">
                    <img class="signal3" src="/resources/ict/typeE/account/img/signal1.svg" alt="">
                    <img class="signal4" src="/resources/ict/typeE/account/img/signal2.svg" alt="">
                </div>
            </div>
