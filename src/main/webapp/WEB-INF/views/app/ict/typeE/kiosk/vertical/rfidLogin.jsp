...
<head>
	...
	<link href="/resources/ict/typeE/common/css/rfid_login.css?v=2" rel="stylesheet" type="text/css" />
...
<div class="dim">
    <div id="container">
        <form:form modelAttribute="member" action="/${homepage.context_path}/ict/kiosk/vertical/rfidProc.do"
                   autocomplete="off" accept-charset="utf-8" onsubmit="return false;">
            <input id="member_id" type="text" name="member_id" size="30" title="아이디" autocomplete="off"
                   style="z-index:100000;position:absolute;top:-10000px;left:150px">
            <div class="container">
                <div class="wrapper">
