...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/typeE/mediawall/css/type_b/a_line_of_book.css" rel="stylesheet" type="text/css" />
		<script src="/resources/ict/typeE/mediawall/js/type_b/wisesaying.js" type="text/javascript"></script>
		<script src="/resources/ict/typeE/mediawall/js/type_b/a_line_of_book.js" type="text/javascript"></script>
	...
	<div class="div_wrap bookline-wrap" id="fade-effect">
		<img class="bg_wrap" src="/resources/ict/typeE/mediawall/img/type_b/a_line_of_book/bg_line.png" />
		...
		<div class="li_book_tit_wrap">
			<div class="line_tit">책 속의 한줄 발견</div>
