...
<div class="popup_overlay" id="popup_logout" style="display: none">
	<div class="popup_wrapper">
		...
		<div class="popup_content">
			${homepage.homepage_name}에서<br>로그아웃 하시겠습니까?
		</div>
...
<!--	<img alt="돌아가기" class="turn_to" src="/resources/ict/kioskVertical/img/common/left_leave.svg" />-->
<!--</div>-->
...
<c:choose>
			...
			<div class="login_btn">
				<c:choose>
					<c:when test="${sessionScope.member.sex eq '0'}">
						<img alt="" class="login_women" src="/resources/ict/kioskVertical/img/common/women_login_02.png" />
					</c:when>
					<c:otherwise>
						<img alt="" class="login_men" src="/resources/ict/kioskVertical/img/common/memoji-m-10.png" />
					</c:otherwise>
				</c:choose>
				<div class="name_div">
					<span>
				...
				<div class="login_frame" id="logout-member">
					<img alt="로그아웃" class="group" src="/resources/ict/kioskVertical/img/common/logout_arrow.svg" />
				</div>
			</div>
		</div>
	</c:when>
	...
	<c:when test="${sessionScope.member.login eq null or !sessionScope.member.login}">
