...
<head>
    ...
    <link href="/resources/ict/typeD/mediawall/css/type_a/best_book.css" rel="stylesheet" type="text/css" />
    <link href="/resources/ict/typeD/mediawall/css/type_a/slick-theme.css" rel="stylesheet" type="text/css" />
    <link href="/resources/ict/typeD/mediawall/css/type_a/slick.css" rel="stylesheet" type="text/css" />
    ...
    <script src="/resources/ict/typeD/mediawall/js/type_a/best_book.js" type="text/javascript"></script>
    <title>도서정보</title>
</head>
<body>
<div class="div_wrap bookinfo-wrap" id="fade-effect">
    <img class="bg_wrap" src="/resources/ict/typeD/mediawall/img/type_a/best_book/bookinfo.png" />
    ...
    <img class="book_mark_01" src="/resources/ict/typeD/mediawall/img/type_a/best_book/group-230.svg" />
    <div class="book_best_h5">
        인기
        <br />
        도서
    </div>
    <img class="book_mark_02" src="/resources/ict/typeD/mediawall/img/type_a/best_book/group-230.svg" />
</div>
</body>
</html>