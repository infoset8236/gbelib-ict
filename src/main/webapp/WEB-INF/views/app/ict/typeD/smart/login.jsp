...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/typeD/account/css/index.css">
		...
		$('#loginBtn').on('click', function(e) {
			...
			$.ajax({
				...
				success: function(response) {
					if (response.valid) {
						location.href='/${homepage.context_path}/ict/smart/main.do';
					} else {
    ...
    <div class="container" tabindex="0">
        <div class="scrollDownArea">
            <div class="content">
                ...
                <form:form modelAttribute="member" action="/${homepage.context_path}/ict/smart/loginProc.do" onsubmit="return false;" id="loginForm" class="loginForm" method="post" autocomplete="off">
                    <form:hidden path="member_pw" cssStyle="display:none;" />
			        <form:hidden path="member_id"/>
                    <label for="member_id_tmp" class="sr-only">
                        <img src="/resources/ict/typeD/account/img/id.svg" alt="">
                    ...
                    <label for="member_pw_tmp" class="sr-only">
                        <img src="/resources/ict/typeD/account/img/password.svg" alt="">
                ...
                <a href="/yy/ict/smart/rfid.do" class="rfidLoginLink" tabindex="0">
                    회원증 RFID로 로그인
                </a>
            </div>
