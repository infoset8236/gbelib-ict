...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/resources/ict/typeD/guestbook/css/gusetbook.css">
    ...
    <script>
        $(document).ready(function () {
            ...
            const qr = new QRCodeStyling({
                width: qrSize,
                height: qrSize,
                data: "https://www.gbelib.kr/${homepage.context_path}/ict/mediawall/createGuestbook.do",
