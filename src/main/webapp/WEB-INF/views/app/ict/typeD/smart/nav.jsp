...
<script>
    ...
    $(document).ready(function () {
        ...
        if (!currentUrl.includes("index") && !currentUrl.includes("localhost")) {
            let idleTime = 0;
            ...
            function doLogout() {
                $.ajax({
                    ...
                    url: "logout.do",
                    success: function () {
                        window.location.href = "/yy/ict/smart/main.do";
                    },
                    error: function () {
    ...
    <c:choose>
        <c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
            ...
            <div class="userState">
                ...
                <a href="/${homepage.context_path}/ict/smart/myPage.do">
                    <span>${sessionScope.member.member_name}</span>님
                </a>
                <button tabindex="0" aria-label="로그아웃" class="logout" id="smartLogoutBtn"></button>
            </div>
        </c:when>
        <c:otherwise>
            <div class="userState" onclick="location.href='/${homepage.context_path}/ict/smart/login.do'">
                <img src="/resources/ict/typeD/common/img/wave/noUser.svg" alt="">
                <a href="/${homepage.context_path}/ict/smart/login.do" tabindex="0">로그인</a>
            </div>
        </c:otherwise>
    </c:choose>

    <a class="goToAI" href="/${homepage.context_path}/ict/smart/ai.do" aria-label="AI안내" tabindex="0"></a>
<%--    <a class="goToAI" onclick="customPopupHtml(`죄송합니다. 현재 서비스 준비 중입니다.<br>더 나은 서비스로 빠른 시일 내에 찾아뵙겠습니다.`);" href="#" aria-label="AI안내" tabindex="0"></a>--%>
    <div class="navigation">
        <a id="search" href="/${homepage.context_path}/ict/smart/main.do" data-paths="/${homepage.context_path}/ict/smart/main.do" tabindex="0">검색</a>
        <a id="chart" href="/${homepage.context_path}/ict/smart/keywordRecom.do" data-paths="/${homepage.context_path}/ict/smart/keywordRecom.do" tabindex="0">키워드추천</a>
        <a id="custom" href="/${homepage.context_path}/ict/smart/smartBookRecom.do" data-paths="/${homepage.context_path}/ict/smart/smartBookRecom.do" tabindex="0">맞춤형추천</a>
        <a id="librarian" href="/${homepage.context_path}/ict/smart/librarianRecom.do" data-paths="/${homepage.context_path}/ict/smart/librarianRecom.do" tabindex="0">사서추천</a>
        <a id="bigData" href="/${homepage.context_path}/ict/smart/bigDataRecom.do" data-paths="/${homepage.context_path}/ict/smart/bigDataRecom.do" tabindex="0">빅데이터추천</a>
        <a id="myPage" href="/${homepage.context_path}/ict/smart/myPage.do" data-paths="/${homepage.context_path}/ict/smart/myPage.do" tabindex="0">나의서재</a>
    </div>
