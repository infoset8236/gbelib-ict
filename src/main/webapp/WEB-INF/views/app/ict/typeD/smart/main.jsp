    ...
    <div class="container" tabindex="0">
        <div class="scrollDownArea">
            ...
            <div class="content">
                ...
                <form id="mainSearchForm" modelAttribute="librarySearch" action="/${homepage.context_path}/ict/smart/search.do" method="post" style="display:none">
                ...
                <div class="recommendIntro" tabindex="0">
                    ...
                    <a class="recommendLink" href="/${homepage.context_path}/ict/smart/keywordRecom.do" tabindex="0">스마트하게 도서 추천 받기</a>
                </div>
            </div>
