...
<html lang="ko">
	...
	<div class="kiosk_course_detail_container_x">
		<div class="kiosk_common_content_x">
			<div class="kiosk_common_header_wrapper_x">
				<div class="kiosk_common_header_kr_x">강좌정보</div>
				<div class="kiosk_common_header_en_x">COURSE INFORMATION</div>
			</div>
			<div class="kiosk_course_detail_content_x">
				<div class="kiosk_course_detail_title_x">
					<div class="kiosk_course_detail_badge_x"><div class="pencil"></div></div>
					<div>
						<div class="kiosk_course_detail_title_label_x">강좌명</div>
						<div class="kiosk_course_detail_title_value_x">${teach.teach_name}</div>
					</div>
				</div>
				<div class="kiosk_course_detail_date_time_wrapper_x">
					<div class="kiosk_course_detail_date_x">
						<div class="kiosk_course_detail_badge_x"><div class="calendar"></div></div>
						<div>
							<div class="kiosk_course_detail_date_label_x">강의기간</div>
							<div class="kiosk_course_detail_date_value_x">${teach.start_date} ~ ${teach.end_date}</div>
						</div>
					</div>
					<div class="kiosk_course_detail_time_x">
						<div class="kiosk_course_detail_badge_x"><div class="mouses"></div></div>
						<div>
							<div class="kiosk_course_detail_time_label_x">접수기간</div>
							<div class="kiosk_course_detail_time_value_x">${teach.start_join_date}&nbsp;${teach.start_join_time} ~ ${teach.end_join_date}&nbsp;${teach.end_join_time}</div>
						</div>
					</div>
				</div>
				<div class="kiosk_course_detail_counter_wrapper_x">
					<div class="kiosk_course_detail_counter_x">
						<div class="kiosk_course_detail_counter_label_x">접수인원</div>
						<div class="kiosk_course_detail_counter_value_x"><span>${teach.teach_join_count}</span><span>/</span>${teach.teach_limit_count}</div>
					</div>
					<div class="kiosk_course_detail_counter_x">
						<div class="kiosk_course_detail_counter_label_x">후보인원</div>
						<div class="kiosk_course_detail_counter_value_x"><span>${teach.teach_backup_join_count}</span><span>/</span>${teach.teach_backup_count}</div>
					</div>
				</div>
			</div>
			<div class="kiosk_course_detail_list_x">
				<div class="kiosk_course_detail_list_item_wrapper_X">
					<div class="kiosk_course_detail_list_item_x">
						<div class="kiosk_course_detail_list_item_label_x">• 강사명</div>
						<div class="kiosk_course_detail_list_item_value_x">
							<c:choose>
					...
					<div class="kiosk_course_detail_list_item_x">
						<div class="kiosk_course_detail_list_item_label_x">• 강좌시간</div>
						<div class="kiosk_course_detail_list_item_value_x">
				...
				<div class="kiosk_course_detail_list_item_wrapper_X">
					<div class="kiosk_course_detail_list_item_x">
						<div class="kiosk_course_detail_list_item_label_x">• 강좌장소</div>
						<div class="kiosk_course_detail_list_item_value_x">${teach.teach_stage}</div>
					</div>
					<div class="kiosk_course_detail_list_item_x">
						<div class="kiosk_course_detail_list_item_label_x">• 수강대상</div>
						<div class="kiosk_course_detail_list_item_value_x">${teach.teach_target}</div>
					</div>
				</div>
				<div class="kiosk_course_detail_list_scroll_wrapper">
					<div class="kiosk_course_detail_list_item_label_x">• 안내사항</div>
					<div class="kiosk_course_detail_list_item_value_x">${teach.teach_desc}</div>
				</div>
			</div>
			<!--	 신청 btn		-->
			<c:choose>
				<c:when test="${teach.teach_status eq '0'}">
					<div class="kiosk_course_detail_apply_x" onclick="teachEdit('${teach.group_idx}','${teach.category_idx}','${teach.teach_idx}','${teach.large_category_idx}', '1');">신청하기</div>
				</c:when>
				<c:when test="${teach.teach_status eq '1'}">
					<div class="kiosk_course_detail_apply_x" onclick="teachEdit('${teach.group_idx}','${teach.category_idx}','${teach.teach_idx}','${teach.large_category_idx}', '2');">대기자신청</div>
				</c:when>
				<c:when test="${teach.teach_status eq '2' or teach.teach_status eq '10'}">
					<div class="kiosk_course_detail_apply_x">신청완료</div>
				</c:when>
				<c:when test="${teach.teach_status eq '3'}">
					<div class="kiosk_course_detail_apply_x">대기자 신청완료</div>
				</c:when>
				<c:when test="${teach.teach_status eq '9'}">
					<div class="kiosk_course_detail_apply_x">수강종료</div>
				</c:when>
				<c:when test="${teach.teach_status eq '4'or teach.teach_status eq '44'}">
					<div class="kiosk_course_detail_apply_x">접수마감</div>
				</c:when>
				<c:when test="${teach.teach_status eq '5'}">
					<div class="kiosk_course_detail_apply_x">정원마감</div>
				</c:when>
				<c:when test="${tach.teach_status eq '6'}">
					<div class="kiosk_course_detail_apply_x">신청대기</div>
				</c:when>
			</c:choose>
