...
<html lang="ko">
	...
	<body>
	<div class="kiosk_new_book_container_x">
		<div class="kiosk_common_content_x">
			<div class="kiosk_common_header_wrapper_x">
				<div class="kiosk_common_header_kr_x">신착도서</div>
				<div class="kiosk_common_header_en_x">NEW BOOK</div>
			</div>
			<div class="kiosk_new_book_swiper_x">
				<div class="swiper">
						...
						<c:forEach items="${newBookList.dsNewBookList}" var="i" varStatus="status">
							<div class="swiper-slide">
								<div class="swiper-item">
									...
									<div class="kiosk_new_book_title_x">${i.TITLE}</div>
									<div class="kiosk_new_book_writer_x">${i.AUTHOR}</div>
									<div class="kiosk_new_book_year_x">${i.PUBLER_YEAR}</div>
								</div>
							</div>
						</c:forEach>
					</div>
