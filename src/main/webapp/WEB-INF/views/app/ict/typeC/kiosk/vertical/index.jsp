...
<body>
<div class="kiosk_main_container">
	<div class="kiosk_main_time">09:52</div>
	<div class="kiosk_main_date">2024. 09. 10. 화요일</div>
	<div class="kiosk_main_message"><span>${homepage.homepage_name}</span><br />방문을 환영합니다</div>
	<div class="kiosk_main_caption">welcome to ${homepage.homepage_eng_name} library</div>
	<!--	 네비게이션 버튼		-->
	<div class="kiosk_main_arrow" onclick="location.href='/${homepage.context_path}/ict/kiosk/vertical/notice.do'"></div>
</div>
</body>
</html>